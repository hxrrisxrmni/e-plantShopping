            ...
            {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((categoryObj, categoryIndex) => (
                        <div key={categoryIndex} className="plant-category"> {/* Fixed typo: classname -> className */}
                            ...
                            <div className='plant-list'>
                                {categoryObj.plants.map((plant, plantIndex) => (
                                    <div key={plantIndex} className='plant-card'>
                                        <img
                                            src={plant.image}
                                            alt={plant.name} // Fixed typo: palnt -> plant
                                        ...
                                        <button 
                                            ...
                                            onClick={() => handleAddToCart(plant)} // Attached click handler
